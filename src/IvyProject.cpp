...
void ProtogenProject::SetBackgroundBaseMaterial(Material *material)
{
    backgroundMaterial.SetBaseMaterial(Material::Add, material);
}
...
void ProtogenProject::SetMaterialColor(){
    switch(Menu::GetFaceColor()){
        case 1: materialAnimator.AddMaterialFrame(yellowMaterial, 1.0f); break;
        case 2: materialAnimator.AddMaterialFrame(orangeMaterial, 1.0f); break;
        case 3: materialAnimator.AddMaterialFrame(whiteMaterial, 1.0f); break;
        case 4: materialAnimator.AddMaterialFrame(greenMaterial, 1.0f); break;
        case 5: materialAnimator.AddMaterialFrame(purpleMaterial, 1.0f); break;
        case 6: materialAnimator.AddMaterialFrame(redMaterial, 1.0f); break;
        case 7: materialAnimator.AddMaterialFrame(blueMaterial, 1.0f); break;
        case 8: materialAnimator.AddMaterialFrame(flowNoise, 1.0f); break;
        case 9: materialAnimator.AddMaterialFrame(rainbowSpiral, 1.0f); break;
        default: break;
    }
}
...
void ProtogenProject::UpdateFace(float ratio) {
    ...
    SetMaterialColor();
    //RGBColor hueFront = gradientSpectrum[0].HueShift(Menu::GetHueF() * 36);
    //RGBColor hueBack  = gradientSpectrum[1].HueShift(Menu::GetHueB() * 36);
    //RGBColor gradient[] = { hueFront, hueBack };
    gradientMat.UpdateGradient(gradientSpectrum);

    flowNoise.SetGradient(gradientSpectrum[0], 0);
    flowNoise.SetGradient(gradientSpectrum[1], 1);
...
void ProtogenProject::AddViseme(Viseme::MouthShape visemeName, float* parameter){
    eEA.AddParameter(parameter, visemeName + 100, 5, 0.0f, 1.0f);
...
void ProtogenProject::AddMaterialFrame(Color color){
    switch(color){
        case CYELLOW:
            materialAnimator.AddMaterialFrame(yellowMaterial, 1.0f);
            break;
        case CORANGE:
            materialAnimator.AddMaterialFrame(orangeMaterial, 1.0f);
            break;
        case CWHITE:
            materialAnimator.AddMaterialFrame(whiteMaterial, 1.0f);
            break;
        case CGREEN:
            materialAnimator.AddMaterialFrame(greenMaterial, 1.0f);
            break;
        case CPURPLE:
            materialAnimator.AddMaterialFrame(purpleMaterial, 1.0f);
            break;
        case CRED:
        ...
        case CBLUE:
            ...
            break;
        case CRAINBOW:
            materialAnimator.AddMaterialFrame(rainbowSpiral, 1.0f);
            break;
        case CRAINBOWNOISE:
            materialAnimator.AddMaterialFrame(flowNoise, 1.0f);
            break;
        default:
            break;
    }
