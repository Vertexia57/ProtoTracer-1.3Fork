...
protected:
    ...
    RGBColor gradientSpectrum[2] = {RGBColor(255, 0, 125), RGBColor(80, 125, 255)};
    GradientMaterial<2> gradientMat = GradientMaterial<2>(gradientSpectrum, 300.0f, false);

    void SetBaseMaterial(Material* material);
    void SetBackgroundBaseMaterial(Material* material);
