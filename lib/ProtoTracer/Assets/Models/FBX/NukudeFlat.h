...
private:
    ...
    static const byte morphCount = 27;
    ...
    Vector3D EyeLashesVectors[2] = {Vector3D(-35.0f, 22.0f, 0.0f),Vector3D(4.0f, 4.0f, 0.0f)};
    ...
    Morph morphs[27] = {
        ...
        Morph(2, EyeLashIndexes, EyeLashesVectors)
    };
