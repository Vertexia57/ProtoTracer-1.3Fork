...
uint8_t Menu::lashed = 0;

//                    111111111111222222222222333333333333444444444444555555555555666666666666777777777777888888888888999999999999111111111111222222222222333333333333444444444444555555555555
String Menu::line1 = "               BRIGHT    SDE BRIGHT     MIC      MIC LEVEL      BOOP        SPEC        SIZE       COLOR       HUE F       HUE B       EFFECT    FAN SPEED   EYELASHES  ";
String Menu::line2 = " a b c d e f   12^45       12^45       ON off     123456|8     on OFF      ON off      12^45      123456|8    123456|8    123456|8    123456|8    123456|8     ON off   ";
...
void Menu::SetMaxEntries() {
    ...
    MenuHandler<menuCount>::SetMenuMax(Lashed, 2);
}
...
void Menu::SetDefaultEntries() {
    ...
    MenuHandler<menuCount>::SetDefaultValue(Lashed, 1);
...
void Menu::GenerateText() {
    ...
    line2 += UseEyelashes() ? "   on OFF   " : "   ON off   ";
...
void Menu::SetUseEyelashes(uint8_t lashes)
{
    Menu::lashed = lashes;
}

uint8_t Menu::UseEyelashes()
{
    if (isSecondary) return lashed;
    else return MenuHandler<menuCount>::GetMenuValue(Lashed);
}
