...
protected:
    ...
    RGBColor gradientSpectrum[7] = {RGBColor(255, 0, 0), RGBColor(255, 255, 0), RGBColor(0, 255, 0), RGBColor(0, 255, 255), RGBColor(0, 0, 255), RGBColor(255, 0, 255), RGBColor(255, 0, 0)};
    GradientMaterial<7> gradientMat = GradientMaterial<7>(gradientSpectrum, 200.0f, false);
